    ...
    public unsafe class Graphics
    {
        ...
        public virtual void FillRectangle(int X, int Y, int Width, int Height, uint Color)
        {
            ...
            for (int y = Y; y < Y + Height; y++)
            {
                ...
                Native.Stosd(VideoMemory + offset, Color, (ulong)Width);
            }
        }
        ...
        public void FillTriangle(int x1, int y1, int x2, int y2, int x3, int y3, uint color)
        {
            ...
            for (int i = 0; i < totalHeight; i++)
            {
                ...
                DrawScanline(ax, bx, y1 + i, color);
            }
        }

        private void DrawScanline(int x1, int x2, int y, uint color)
        {
        ...
        public virtual void DrawPoint(int X, int Y, uint color)
        {
