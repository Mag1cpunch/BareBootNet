...
# List of directories containing C# and C source files
Includes = ["ConsoleOS"]
CIncludes = [] # "LibC", "NativeLib"
...
def main(workPath):
    ...
    os.makedirs(obj_dir, exist_ok=True)  # Ensure output directory exists
    ...
    # Compile each .c file separately into .o files
    object_files = []
    for include in CIncludes:
        ...
        for c_file in c_files:
            ...
            print(f"Compiling: {gcc_command}")  # Debug output
            os.system(gcc_command)

    # Construct bflat command with .o files
    if object_files:
    ...
    print(f"Running bflat: {bflat_command}")  # Debug output
